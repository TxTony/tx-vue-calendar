<template>
  <div id="app">
    <div id="#overlay" v-if="currentCalendar">
      <button @click="currentCalendar.prev()">prev</button>
      <button @click="currentCalendar.today()">today</button>
      <button @click="currentCalendar.next()">next</button>

      <button @click="currentCalendarView = 'month'">Month</button>
      <button @click="currentCalendarView = 'day'">Day</button>
      <button @click="currentCalendarView = 'week'">week</button>
